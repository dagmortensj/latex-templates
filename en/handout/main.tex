...
turning points occur where $E = V(x)$. The subsection heading above
sits one size step below the section title, while remaining at body
size --- enough to mark a finer level when the handout is used for
lecture notes.
