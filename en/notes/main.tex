...
syntax highlighting directly in the notes. It is well suited for
short scripts that accompany an analytical derivation — for
instance, computing and printing expectation values for the
eigenstates found in the previous sections.

The script below evaluates the probability density
$|\psi_n(x)|^2$ of the infinite square well numerically,
