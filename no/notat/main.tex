...
syntaksutheving direkte i notatene. Den passer godt til korte
skript som følger en analytisk utledning — for eksempel
beregning av forventningsverdier for egentilstandene funnet i
de foregående seksjonene.

Skriptet nedenfor evaluerer sannsynlighetstettheten
$|\psi_n(x)|^2$ for den uendelig dype brønnen numerisk, og
integrerer deretter $\langle x \rangle = \int_0^L x\,|\psi_n|^2\,\mathrm{d}x$
...
for n in range(1, 4):
    tetthet = psi(n, x)**2          # sannsynlighetstetthet |psi_n|^2
