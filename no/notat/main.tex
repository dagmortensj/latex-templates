...
% darkolive til kurver / bølgefunksjoner, svart til akser og vegger, og grå
% til sekundære etiketter. darkred er reservert for hyperlenker og
...
\begin{figure}[H]
  ...
  \caption{Uendelig dyp brønn: energinivåer $E_n \propto n^2$
           ...
           egenfunksjoner $\psi_n$ (\textcolor{darkolive}{olivengrønn}).}
  \label{fig:bronnn}
\end{figure}
